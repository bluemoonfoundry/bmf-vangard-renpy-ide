      ...
      '/guide/': [
        {
          ...
          items: [
            ...
            { text: '5. Managing Story Elements', link: '/guide/managing-story-elements' },
            { text: '6. Visual Composers', link: '/guide/visual-composers' },
            { text: '7. Diagnostics and Quality', link: '/guide/diagnostics-and-quality' },
            { text: '8. Writing Code', link: '/guide/writing-code' },
            { text: '9. Working with Assets', link: '/guide/working-with-assets' },
            { text: '10. Seeing Your Story — The Three Canvases', link: '/guide/three-canvases' },
